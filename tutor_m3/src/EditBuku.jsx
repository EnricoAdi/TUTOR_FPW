  ...
  return (
    <>  
      ...
      {/* masing-masing input akan kita registerkan pada useForm */}
        ...
        <input type="radio" name="type" value="Enrico" {...register("pengarang")} defaultChecked={tempBook.pengarang=="Enrico"}/>Enrico <br />
        <input type="radio" name="type" value="Bukan Enrico" {...register("pengarang")} defaultChecked={tempBook.pengarang=="Bukan Enrico"}/>Bukan Enrico <br />
