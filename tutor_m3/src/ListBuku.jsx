...
const ListBuku = (props) => {
  ...
  const schema = Joi.object({
    ...
    pengarang: Joi.string().required().valid("Enrico","Bukan Enrico").messages({
  ...
  return (
    <>
      ...
      {/* masing-masing input akan kita registerkan pada useForm */}
        ...
        <input type="radio" name="type" value="Enrico" {...register("pengarang")} />Enrico <br />
        <input type="radio" name="type" value="Bukan Enrico" {...register("pengarang")} />Bukan Enrico <br />
